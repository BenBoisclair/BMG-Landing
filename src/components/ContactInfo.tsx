            ...
            <div className="space-y-4 text-gray-700">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:089-8416226" className="text-primary hover:underline transition-colors duration-200">089-8416226</a>
                  <br />
                  <a href="tel:087-7896226" className="text-primary hover:underline transition-colors duration-200">087-7896226</a>
                  <br />
                  <a href="tel:02-8887788" className="text-primary hover:underline transition-colors duration-200">02-8887788</a>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:bmgthailand@gmail.com" className="text-primary hover:underline transition-colors duration-200">bmgthailand@gmail.com</a>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="https://facebook.com/bmgthailand" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline transition-colors duration-200">bmgthailand</a>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/bmgstone" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline transition-colors duration-200">@bmgstone</a>
                </div>
              </div>
            </div>
          </div>
